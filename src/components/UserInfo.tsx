...
// Define the User interface to specify the expected shape of the user prop
interface User {
    name: string;
    email?: string; // The email field is optional
}

interface UserInfoProps {
    user: User; // Define the props type for UserInfo
}
